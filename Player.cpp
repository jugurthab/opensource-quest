...
void Player::loadObject(std::string imgFileNameP, std::string imageIDP, int imgXPosP, int imgYPosP, int imgWidthP, int imgHeightP, int currentFrameP, int currentRowP){
    imgXPos = imgXPosP;
    imgYPos = imgYPosP;
...
void Player::drawObject(SDL_RendererFlip flip){
